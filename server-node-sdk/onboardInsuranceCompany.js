...
async function main() {
  try {
    ...
    if (userIdentity) {
      console.log(
        'An identity for the user "insuranceCompany01" already exists in the wallet',
      );
      return;
    }
    ...
    console.log(
      'Successfully registered and enrolled insuranceAdmin user "insuranceCompany01" and imported it into the wallet',
    );
  } catch (error) {
